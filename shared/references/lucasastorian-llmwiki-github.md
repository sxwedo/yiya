---
type: Reference
title: "lucasastorian/llmwiki（GitHub）"
description: "lucasastorian/llmwiki 书签：Karpathy LLM Wiki 的开源实现"
status: draft
domain: shared
...
- **为什么收藏**：Karpathy LLM Wiki 的开源实现
- **何时用**：要对齐源码、Issue、Release 或安装入口时从这里进。
- **raw**：收入 `raw/bookmarks/github.md` 列表；原文 URL 仍为 https://github.com/lucasastorian/llmwiki
