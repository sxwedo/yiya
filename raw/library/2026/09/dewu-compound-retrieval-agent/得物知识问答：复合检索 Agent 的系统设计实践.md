...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_1.gif)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_2.jpg)

### 多源并行检索能力

Agent 可用的工具覆盖知识库数据源 + 三类个人飞书数据源，全部根据用户的前端勾选和权限动态激活。Agent 自主判断何时调用哪个工具，整个过程对用户透明：

![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_3.png)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_4.png)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_5.png)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_6.png)
...
Flux onActing(Agent agent, ActingInput input, next){
...
List filter(String query, List items){
    // ── Stage 0: FastPass ──
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_7.png)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_8.png)
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_9.png)

另外在技术选型阶段，我们将 AgentScope 2.0 与 Java 生态的主流 AI 框架进行了详细对比：

![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_10.png)

### 往期回顾

## 1. 实战从零开始构建一个Coding Agent：Violin ｜得物技术
...
![](./media/得物技术_EIXbIqUYcnFHpwAiPsJDEg_11.jpg)
