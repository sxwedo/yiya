---
title: "2026年个人Agent自建实战：我用Vibe Coding + 借开源轮子，15天搭出每天都在用的工作系统（方法篇）"
author: "Xudong Han (@Xudong07452910)"
url: "https://x.com/Xudong07452910/status/2051891753821556976"
ingested: "2026-09-07"
date: "Wed May 06 05:08:11 +0000 2026"
...
- Pi-mono（https://github.com/badlogic/pi-mono）是一个非常干净的Agent基础包，OpenClaw很多思路都来自它，喜欢极简风格的同学可以从这个起手。

- Nanobot（https://github.com/HKUDS/nanobot）是后来出现的「ultra-lightweight版OpenClaw」，几千行核心代码就能跑完整Agent循环，自带memory、skills、multi-provider，飞书、Slack、Telegram、Discord这些聊天通道都内置好了，扩展性极强。我最后选的是它，省下来的工程脚手架时间至少三个月。
...
它会一步一步告诉你要做什么。但飞书这一步比较特殊，Claude Code帮不了你点飞书开放平台的网页，凭证必须你自己去拿。流程在 https://open.feishu.cn/app ，4步搞定。

- 第一步，创建一个「企业自建应用」。

- 第二步，启用「机器人」能力，申请\`im:message\`、\`im:message.p2p\_msg:readonly\`、\`cardkit:card:write\`这三个权限（如果你还想要群聊和文件传输，再加上\`im:message.group\_msg:readonly\`和\`im:resource\`）。
...
\`\`\`markdown
\- WHAT，这个项目是干嘛的，一句话讲清
\- WHY，哪些设计选择不能动，比如「channels目录保持nanobot上游可合并，自定义skill全部放custom\_skills/」
...
\- \`docs/prompt\_plan.md\`，把spec拆成分步可执行的prompt序列
...
第三步，重启Claude Code会话。最新配置字段见 https://code.claude.com/docs/en/mcp 。
...
### 1 @Xudong07452910 (Xudong Han) (Author)

*Wed May 06 09:22:34 +0000 2026*

很感谢Nanobot的负责人@xubinrencs也转发了这篇文章，这么优秀的4.3万 star的开源项目，值得所有考虑自建个人Agent的朋友看见。

### 2 @dalviker (dalviker)

*Thu May 07 12:53:17 +0000 2026*

@Xudong07452910 收藏，自己搭建应该更简洁，更符合定制需求

### 3 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 13:13:20 +0000 2026*

@dalviker 是的呀，这算是自己定制化自己的Agent。

### 4 @AlvisAiYao (Alvis Ai)

*Thu May 07 18:14:21 +0000 2026*

@Xudong07452910 纯干货

### 5 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 18:17:04 +0000 2026*

@AlvisAiYao 谢谢支持😁

### 6 @zwdroidai (zwdroid)

*Thu May 07 00:33:51 +0000 2026*

@Xudong07452910 nanobot 是相对来说好理解的，剥离 channel 层，真正的核心代码不多。这个协议我看没有提到公司和组织，不知道是否有限制公司私用部署。

### 7 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 02:55:08 +0000 2026*

@zwdroidai 这个是香港大学实验室的产品

### 8 @cryozerolabs (冰零)

*Thu May 07 09:07:45 +0000 2026*

@Xudong07452910 太强了！

### 9 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 09:14:10 +0000 2026*

@cryozerolabs 谢谢

### 10 @lanze326 (blue)

*Wed May 06 17:15:46 +0000 2026*

@Xudong07452910 非常棒 我已经开发到多agent自动切换模型协作了 同模型设计执行验收会有视觉障碍。 我就分主设计加俩参谋 执行单独用claude 验收在设计那三个就行了

### 11 @Xudong07452910 (Xudong Han) (Author)

*Wed May 06 17:29:51 +0000 2026*

@lanze326 厉害👍🏻，学习了，我也在慢慢摸索当中。

### 12 @swg209 (小苏 | AI出海)

*Thu May 07 00:44:28 +0000 2026*

@Xudong07452910 好详细的教程，学到了claude code 和codex的左右互搏，还有脑暴需求时，让AI用对话式反复追问，直至需求边界明确。 谢谢大佬分享

### 13 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 02:59:00 +0000 2026*

@swg209 谢谢，这也都是平时需要不断积累的一些东西，多去实践，也会有自己与AI coding 的协作流程

### 14 @TunshuPro (Tunshu)

*Thu May 07 01:15:10 +0000 2026*

@Xudong07452910 hermes Nanobot两个有什么区别

### 15 @Xudong07452910 (Xudong Han) (Author)

*Thu May 07 03:00:42 +0000 2026*

@TunshuPro Hermes agent主打自进化的功能，Nanobot是轻量化版本的openclaw

### 16 @yshnln (shan)

*Wed May 06 14:51:58 +0000 2026*

@Xudong07452910 很详细，转一个

### 17 @Xudong07452910 (Xudong Han) (Author)

*Wed May 06 15:00:41 +0000 2026*

@lnyisn 谢谢，这篇可能比较偏向于方法论层面的，后面会连载一些更细节的搭建经验，还有我踩得坑。

### 18 @hilllike (wisexx)

*Wed May 06 15:19:46 +0000 2026*

@Xudong07452910 感谢分析

### 19 @Xudong07452910 (Xudong Han) (Author)

*Wed May 06 15:21:54 +0000 2026*

@hilllike 谢谢，由于篇幅限制原因，还有很多细节没有展开说，之后会继续分享系列文章。

### 20 @jiangding01 (一页繁华)

*Thu Jun 04 15:13:07 +0000 2026*

@Xudong07452910 用对话让Claude Code反复追问需求边界再写spec.md这步性价比最高，我以前直接丢模糊需求结果返工好几次

### 21 @najie001 (najie)

*Thu May 14 17:34:51 +0000 2026*

@Xudong07452910 nb

### 22 @fanye471733 (fan ye)

*Thu May 14 13:14:15 +0000 2026*
