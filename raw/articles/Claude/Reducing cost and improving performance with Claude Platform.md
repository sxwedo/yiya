...
![Figure 3. The effect of prompting anti-patterns during model migration from Opus 4.8 to Opus 5.](../_media/claude-reducing-cost-and-improving-performance-with-claude-platform/Lance_Martin_reducing-cost-and-improving-performance-with-claude-platform_3.png)
...
![Figure 7. Cost and performance change across benchmarks with /claude-api cost-optimize.](../_media/claude-reducing-cost-and-improving-performance-with-claude-platform/Lance_Martin_reducing-cost-and-improving-performance-with-claude-platform_7.png)
