...
![Claude Code's system prompt is organized so the stable pieces stay cached and only the conversation itself grows turn by turn.](../_media/claude-lessons-from-building-claude-code-prompt-caching-is-everythi/Claude_lessons-from-building-claude-code-prompt-caching-is-everything_1.png)
...
![When the context window fills up, Claude Code forks a cached call to summarize the conversation, then resumes with the summary in place of the original messages.](../_media/claude-lessons-from-building-claude-code-prompt-caching-is-everythi/Claude_lessons-from-building-claude-code-prompt-caching-is-everything_2.png)
