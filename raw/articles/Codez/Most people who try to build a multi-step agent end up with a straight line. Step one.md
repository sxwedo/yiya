...
ingested: "2026-09-07"
date: "Mon Jul 20 11:23:31 +0000 2026"
...
![Image](../_media/x-2079165300625330317/0xCodez_2079165300625330317_1.jpg)
...
const raw = await parallel(
  SOURCES.map((s) =&gt; () =&gt;
    agent(s.prompt, {
      ...
      phase: 'Research',
      schema: ITEM\_SCHEMA,     // each node returns validated JSON
      agentType: 'general-purpose',
    }),
  ),
);
...
const curated = await agent(
  ...
  { phase: 'Curate', schema: CURATED\_SCHEMA },
);
\`\`\`
...
*Mon Jul 20 11:24:26 +0000 2026*

@0xCodez that 14 step breakdown for graph engineering with claude sounds seriously structured

### 2 @0xCodez (Codez) (Author)

*Mon Jul 20 11:26:03 +0000 2026*

@gippp69 Graph engineering is the next big thing after you know how to build loops.

### 3 @rewind02 (rewind)

*Mon Jul 20 11:28:42 +0000 2026*

@0xCodez parallel agents change everything

### 4 @0xCodez (Codez) (Author)

*Mon Jul 20 11:33:46 +0000 2026*

@rewind02 yeah, Graph Engineering is next big trend !

### 5 @ridark_eth (Ridark)

*Mon Jul 20 11:28:43 +0000 2026*

@0xCodez Real treasure in the article, thanks, how did the idea come to you?

### 6 @0xCodez (Codez) (Author)

*Mon Jul 20 11:35:38 +0000 2026*

@ridark\_eth I was exploring loop engineering and how to build stronger systems.

### 7 @de1lymoon (Alex)

*Mon Jul 20 13:37:52 +0000 2026*

@0xCodez Broski, as always great job - saved this gem article

### 8 @0xCodez (Codez) (Author)

*Mon Jul 20 16:36:00 +0000 2026*

@de1lymoon You are welcome Alex. Drop me you thoughts on article after you read

### 9 @undefinedKi (Yarchi)

*Mon Jul 20 13:14:34 +0000 2026*

@0xCodez another brilliant article from Codez

### 10 @0xCodez (Codez) (Author)

*Mon Jul 20 16:35:38 +0000 2026*

@undefinedKi Thx Yarchi. Have you read about Graph engineering before ?

### 11 @alphabatcher (Alpha Batcher)

*Mon Jul 20 15:32:59 +0000 2026*

@0xCodez great breakdown about graph engineering

### 12 @0xCodez (Codez) (Author)

*Mon Jul 20 15:36:04 +0000 2026*

@alphabatcher thx Batcher. Btw are you building your own graphs ?

### 13 @0xClodex (Clodex)

*Mon Jul 20 11:36:52 +0000 2026*

@0xCodez new loop engineering?

### 14 @0xCodez (Codez) (Author)

*Mon Jul 20 11:47:43 +0000 2026*

@0xClodex even bigger topic !

### 15 @KevinMilczewski (Kevin Milczewski)

*Mon Aug 24 03:24:58 +0000 2026*

@0xCodez The irony of this post being full of easily identifiable claude text patterns is hilarious.

### 16 @Vanarchain (Vanar)

*Mon Jul 20 22:38:55 +0000 2026*

@0xCodez AI doesn't replace curiosity. It gives curious people a much bigger search space to explore.

### 17 @tetumemo (テツメモ｜AI図解×検証｜Newsletter)

*Tue Jul 21 13:33:16 +0000 2026*

@0xCodez @LilysAI\_要約して

### 18 @HarryTandy (Harry Tandy)

*Tue Jul 21 11:02:32 +0000 2026*

@0xCodez orchestration via code instead of chat context is the real meta shift

### 19 @phosphenq (Phosphen)

*Mon Jul 20 14:48:53 +0000 2026*

@0xCodez wow, another baner for Codez!

### 20 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Thu Aug 13 13:28:27 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2087889572038340761)

### 21 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Tue Jul 28 10:43:59 +0000 2026*

@0xCodez There will be signs. The signs:

[x.com/gerardsans/sta…](https://x.com/gerardsans/status/2081729047436923315)

### 22 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Thu Jul 23 12:47:13 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2080265890029838728)

### 23 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Tue Jul 21 20:51:51 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2079529665178259917)

### 24 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Tue Jul 21 13:25:07 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2079517195688628516)

### 25 @Code_of_Kai (Code_of_Kai)

*Sun Jul 26 16:21:18 +0000 2026*

@0xCodez @threadreaderapp

### 26 @The_Kid_Icarus (Icki)

*Tue Jul 21 12:20:30 +0000 2026*

@0xCodez Interesting - I have some questions though - as with loops. Who has the usage for deep-research loops etc. how do you manage token efficiency. These look great but appear to be very heavy autonomous process.

### 27 @nicholas_diao (Nick Diao)

*Wed Jul 22 18:07:34 +0000 2026*

@0xCodez Check out Fractal (open source), which dynamically constructs recursive graphs of looping agents: [github.com/plasma-ai/frac…](https://github.com/plasma-ai/fractal)

### 28 @DougFullington (Doug Fullington, MD)

*Mon Jul 20 13:53:13 +0000 2026*

@0xCodez Does it have to be this complicated or can I just ask Fable or Sol to orchestrate and spin up subagents as needed?

### 29 @1amageek (村本章憲 - Norikazu Muramoto)

*Mon Jul 20 22:09:38 +0000 2026*

@0xCodez 宣言的にGraphを構築できる方がいいよ。

[github.com/1amageek/Swift…](https://github.com/1amageek/SwiftAgent)

### 30 @mazci33 (mazci)

*Tue Jul 21 14:17:49 +0000 2026*

@0xCodez Are you familiar whit BlockDAG? #KAS

### 31 @Truntr_ (Truntr)

*Mon Jul 20 14:24:58 +0000 2026*

@0xCodez "Prompter asks a question. Architect draws a graph." - the reveal.

Add one more tier: the compiler ships the graph as a skill and calls it twice.

Prompter debates.
Architect builds.
Compiler resells.

The distance between them compounds monthly.

### 32 @leefaus (Lee Faus)

*Mon Jul 20 17:09:45 +0000 2026*

@0xCodez we saw this coming 6 months ago and started building @atomicdotdev so you can maintain your causal graph all the way intent to storage.  we even go as far as using semantic web to link nodes together as ontologies and taxonomies.

### 33 @CodingDevTools (Jaixii | Building Engraphis)

*Fri Jul 24 06:28:38 +0000 2026*

@0xCodez [engraphis.com](https://engraphis.com/) Best agentic memory with graph system there is

### 34 @tamy_mammi (Kiev.kas 𐤊🇯🇵🐬)

*Tue Jul 21 16:33:11 +0000 2026*

@0xCodez Kaspa DAG omg never seen something like this

### 35 @shrinathv (Shrinath V)

*Wed Jul 22 08:47:31 +0000 2026*

@0xCodez Super interesting stuff. I ran a check on something I've been building and there is a lot of convergence. Your article gave me the missing framework to explain this. 

![Image](../_media/x-2079165300625330317/shrinathv_2079850819164549199_1.jpg)

### 36 @monkwithamac (monk with a mac)

*Tue Jul 21 02:01:10 +0000 2026*

@0xCodez Just use langgraph and be done with this. I wish we stop calling it everything engineering (prompt, context, loop, graph)…
