...
*Tue Jun 09 16:27:40 +0000 2026*

@0xCodez Amazing read as always Codez ! Booking it. Will read right now !

### 2 @0x_rody (rody)

*Tue Jun 09 16:15:35 +0000 2026*

@0xCodez you are sooo good!

### 3 @0xCodez (Codez) (Author)

*Tue Jun 09 16:16:19 +0000 2026*

@0x\_rody Thanks you Rody ! You are the legend too

### 4 @rewind02 (rewind)

*Tue Jun 09 16:03:56 +0000 2026*

@0xCodez the workflow became the real moat

### 5 @0xCodez (Codez) (Author)

*Tue Jun 09 16:06:14 +0000 2026*

@rewind02 Yeah, this is true - loop engineers will win in the long term, that’s for sure. Are you using loops yourself?

### 6 @uttamm_gupta (Uttam Gupta)

*Tue Jun 09 16:09:25 +0000 2026*

@0xCodez Leverage is no longer in prompts it’s in building loops that execute, verify, and improve work automatically.

### 7 @0xCodez (Codez) (Author)

*Tue Jun 09 16:12:24 +0000 2026*

@uttamm\_gupta Yeah, self-improving agent engineering is the most important skill for the future, in my opinion.

### 8 @zhc0503 (喵大人)

*Wed Jun 24 12:45:55 +0000 2026*

@0xCodez 让我们做事也该如此，最佳结果=最小可行 x 循环迭代！

### 9 @tetumemo (テツメモ｜AI図解×検証｜Newsletter)

*Tue Jun 23 09:28:23 +0000 2026*

@0xCodez @LilysAI\_ 要約して

### 10 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Wed Jun 10 01:04:51 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2062579164268445965)

### 11 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Tue Jun 09 21:41:02 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2064373120895451495)

### 12 @AIghtBetSports (AIghtBet Sports LLC)

*Wed Jun 24 17:33:36 +0000 2026*

@0xCodez 🫵🏼😎🤝🏻 goat

### 13 @alannnfx (Alan)

*Mon Jun 15 14:16:56 +0000 2026*

@0xCodez @badboyfoxy here you go

### 14 @WalrusProtocol (Walrus)

*Wed Jun 17 21:41:17 +0000 2026*

"The agent forgets, the file does not" 🦭 step 10 is the spine of the whole thread.
...
*Wed Jun 10 05:59:56 +0000 2026*

@0xCodez great job, many people who are just starting to deal with AI have a question of where to start, and this is exactly what can help them.

### 16 @brianmcgrath (BrianMcGrath)

*Sat Jun 20 11:57:10 +0000 2026*

@0xCodez I’d love to see a couple real examples of this.

### 17 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Sun Aug 02 14:07:01 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2083909264960086484)

### 18 @gerardsans (Gerard Sans | Axiom 🇬🇧)

*Wed Jun 10 14:43:35 +0000 2026*

@0xCodez [x.com/gerardsans/sta…](https://x.com/gerardsans/status/2064704367131791499?s=20)

### 19 @The_Kid_Icarus (Icki)

*Sat Jul 11 18:32:39 +0000 2026*

@0xCodez Read your articles. The one area I’m unclear is how you imply very long running sessions. How do you manage the context how do your loops and autonomous runs do it. Surely you don’t just let them run into compact?

### 20 @IzzyPollak (ɪᴢᴢʏ ᴘᴏʟʟᴀᴋ)

*Mon Jun 15 11:48:24 +0000 2026*

@0xCodez @grok can you summarize and teach me the principles of this article?

### 21 @sbmeunier (Sebastien Meunier)

*Sat Jun 20 07:34:20 +0000 2026*

@0xCodez @blaizedsouza lol

### 22 @IzzyPollak (ɪᴢᴢʏ ᴘᴏʟʟᴀᴋ)

*Mon Jun 15 11:47:53 +0000 2026*

@nikitabier brother this is my first product request given your new station 🙌 awesome seeing @benjitaylor and you at work.

I find myself a collector of articles. I have all the categories and best content but don’t have the time to consume all of it.

A few ways I’d love to be able to modify an article using grok for easier consumption;

\- text to voice -&gt; then play on 1.5-2x speed
\- distill  / summarize / ELi8
\- /teach me this concept

Excited to see you both cook, sending good vibes from Austin

### 23 @0xMoysei (Moysei)

*Tue Jun 09 17:51:12 +0000 2026*

@0xCodez nice job Codez!

### 24 @peterdjames (Peter James)

*Wed Jun 24 06:30:16 +0000 2026*

@0xCodez is it just me or does none of my work involve repetitive tasks? I'm constantly building new things.

### 25 @teco_dev (teco)

*Wed Jun 24 16:56:04 +0000 2026*

@0xCodez @threadreaderapp unroll

### 26 @rqaiiii (rq)

*Wed Jun 24 14:53:03 +0000 2026*

@0xCodez @grok tldr, build a bullet point that I can handoff directly to Claude code

### 27 @RogerThatJim (This is jim)

*Tue Jun 09 23:11:02 +0000 2026*

@0xCodez Loop = faster way to use tokens and faster slop

### 28 @eydempa (ベアブリ)

*Wed Jun 24 06:55:21 +0000 2026*

@0xCodez @LilysAI\_ 要約して

### 29 @RichardFedorko (Richard Fedorko)

*Wed Jun 24 08:50:54 +0000 2026*

@0xCodez Thank you for a valuable article. After reading it, I am slightly less skeptical about loop coding. I will definitely test your recommended approach in practice.

### 30 @ZetsubosenseiG (Zaeon Gao)

*Sun Jul 12 03:50:20 +0000 2026*

@0xCodez [x.com/zetsubosenseig…](https://x.com/zetsubosenseig/status/2076145807527489838) 

![Image](../_media/x-2064374643729773029/ZetsubosenseiG_2076152152335008052_1.jpg)

### 31 @webdreams32 (Bobby Karuturi)

*Thu Jun 25 00:16:07 +0000 2026*

@0xCodez Can I loops for adding new features or building a green field app?

### 32 @MatheusSimonaci (Matheus Simonaci)

*Wed Jun 24 03:36:05 +0000 2026*

@0xCodez thanks bro, this teached me a lot!

### 33 @BDiobosco36554 (Bernardo Diobosco)

*Wed Jun 24 15:56:13 +0000 2026*

@0xCodez @threadreaderapp unroll

### 34 @Prakhar314 (Gary Allen)

*Wed Jun 24 06:27:57 +0000 2026*

@0xCodez This is helpful thanks

### 35 @mykeola080 (Michael Oladimeji)

*Wed Jun 24 03:31:33 +0000 2026*

@0xCodez Seems like something I need to learn how to implement
