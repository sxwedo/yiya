...
author: "宝玉 (@dotey)"
url: "https://x.com/dotey/status/2034002188994060691"
ingested: "2026-09-07"
date: "Tue Mar 17 20:21:26 +0000 2026"
...
[Embedded Tweet: https://x.com/i/status/2033949937936085378]
...
*Wed Mar 18 00:20:14 +0000 2026*

@dotey 很多人写 description 时会写“这个 Skill 做什么”，但 Claude 需要的是“什么情况下该用这个 Skill”。好的 description 读起来更像 if-then 条件，而不是功能说明。

### 2 @xxiangshi (Xiang)

*Wed Mar 18 00:12:34 +0000 2026*

@dotey 把这篇文章直接塞给Claude 让它建立一个创建skill的skill
然后创建一个skill让Claude自己网上找类似文章然后创建创建skill的skill
最后创建一个skill自己搜索网上搜索文章创建创建skill的skill然后创建类似的skill

### 3 @hiheimu (赖叔 | LaiShu.ai)

*Wed Mar 18 06:32:20 +0000 2026*

@dotey 正好做了个图来加深理解 

![Image](../_media/x-2034002188994060691/hiheimu_2034155928061415511_1.jpg)

### 4 @Bryant57153 (Bryant)

*Wed Mar 18 01:25:59 +0000 2026*

@dotey 分类和写法都对，但没解决最痛的问题：skill腐烂。API改了、CLI升级了、内部工具重构了，skill没人跟着改就静默失败。赌一个：半年后那几百个内部skill，活跃率不到30%。

### 5 @YanyuRensheng (S Li)

*Tue Mar 17 21:19:12 +0000 2026*

@dotey skill依然符合提示词或者上下文优化的一个基本原则：越专注越有效。

### 6 @yungui_ml (云归)

*Wed Mar 18 10:11:47 +0000 2026*

@dotey Skill 维护上其实也可以参考软件工程的理念，对通用部分进行抽离，做成独立的 md 被多个 skill 复用引用，或者直接做成一个独立的 skill。

现在很多的 skill 其实有很多重复的内容，完全可以优化一下，说不定未来会出现一个 skill build 脚手架，自动抽离复用的片段或脚本😂

### 7 @BohuTANG (Bohu)

*Wed Mar 18 01:47:58 +0000 2026*

@dotey 这块应该还有不少问题，让这些 skill 协作和真正工作起来复杂度有点高，比较直接的方式是官方开源让大家可以直接使用

### 8 @realtimeslices (Mark)

*Wed Mar 18 14:03:46 +0000 2026*

@dotey 刚刷到原作者的推，翻译就来了，感谢分享🫡

### 9 @linarich0015 (橙小禾)

*Wed Mar 18 01:20:08 +0000 2026*

@dotey 我无法了 用NotebookLM把这篇转语音，怎么转都是英文对话🥹 我想他读到了原文

### 10 @wanghon18919006 (julywhj)

*Wed Mar 18 03:14:45 +0000 2026*

@dotey 服务API更新 skills 不及时维护，无用的skills会越来越多，用户找不到好用的可用的skills，慢慢大家就会放弃skills，就和曾经MCP一样，协议非常复杂，现在AI已经不需要那么复杂的协议了。

### 11 @flying_crp (flyingcrp)

*Wed Mar 18 00:38:18 +0000 2026*

@dotey 那是不是为了让 Claude code 与已有工程习惯一致，可以为这个工程建一个项目共享的 Skills，这个 skill 里面告诉 Claude 在这个项目中如何规划模块，如何测试，如何调用第三方服务，通过 skill 来引导开发？这部分本来是在 Claudemd 中

### 12 @SpringHaoAI (Spring Hao)

*Wed Mar 18 00:35:32 +0000 2026*

@dotey Agent Skills 是 AI 发展中的一项重大突破，让工作流像传统软件一样即装即用。

### 13 @Microstrongs (microstrong)

*Wed Mar 18 04:48:54 +0000 2026*

@dotey 基础知识值得好好学习

### 14 @zhiyebanzhuan (UBsoft)

*Wed Mar 18 02:30:53 +0000 2026*

@dotey 总体来说还是写给开发者的，非代码从业者没什么切入的角度

### 15 @hzyyqysysai (BBJ.AI)

*Wed Mar 18 13:27:59 +0000 2026*

@dotey 点赞

### 16 @da_kaola (大烤拉)

*Wed Mar 18 10:08:09 +0000 2026*

@dotey @grok 总结我发给claude ai学习

### 17 @Alfredxia (SnowShadow)

*Wed Mar 18 02:44:49 +0000 2026*

@dotey 企业内部的注册分发是一个问题，看到nacos 3.1版本在尝试解决这个问题了

### 18 @lynnchen80 (晨曦)

*Wed Mar 18 16:38:00 +0000 2026*

@dotey Skill没有很严谨的规则，边界感不强，跟传统写代码有区别，是一种泛化的能力，需求和流程发生变化，就得重构。

### 19 @longche89014674 (byy)

*Wed Mar 18 04:44:24 +0000 2026*

@dotey 挺好的

### 20 @footimura (rootball)

*Wed Mar 18 01:32:07 +0000 2026*

@dotey Skills is all

### 21 @aches_cn (sehca)

*Thu Mar 19 11:46:15 +0000 2026*
