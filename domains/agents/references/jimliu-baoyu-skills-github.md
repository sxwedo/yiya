---
type: Reference
title: "JimLiu/baoyu-skills（GitHub）"
description: "JimLiu/baoyu-skills 书签：宝玉的日常 Agent Skills 集"
status: draft
domain: agents
...
- **为什么收藏**：宝玉的日常 Agent Skills 集
- **何时用**：要对齐源码、Issue、Release 或安装入口时从这里进。
- **raw**：收入 `raw/bookmarks/github.md` 列表；原文 URL 仍为 https://github.com/JimLiu/baoyu-skills
