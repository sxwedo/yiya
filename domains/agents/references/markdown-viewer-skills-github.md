---
type: Reference
title: "markdown-viewer/skills（GitHub）"
description: "markdown-viewer/skills 书签：给 Agent 画图与可视化的 Skills"
status: draft
domain: agents
...
- **为什么收藏**：给 Agent 画图与可视化的 Skills
- **何时用**：要对齐源码、Issue、Release 或安装入口时从这里进。
- **raw**：收入 `raw/bookmarks/github.md` 列表；原文 URL 仍为 https://github.com/markdown-viewer/skills
