---
type: Reference
title: "BuilderIO/skills（GitHub）"
description: "BuilderIO/skills 书签：Builder.io 的编码代理 Skills"
status: draft
domain: agents
...
- **为什么收藏**：Builder.io 的编码代理 Skills
- **何时用**：要对齐源码、Issue、Release 或安装入口时从这里进。
- **raw**：收入 `raw/bookmarks/github.md` 列表；原文 URL 仍为 https://github.com/BuilderIO/skills
