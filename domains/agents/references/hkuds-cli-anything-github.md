---
type: Reference
title: "HKUDS/CLI-Anything（GitHub）"
description: "HKUDS/CLI-Anything 书签：让任意软件变成 Agent-native CLI"
status: draft
domain: agents
...
- **为什么收藏**：让任意软件变成 Agent-native CLI
- **何时用**：要对齐源码、Issue、Release 或安装入口时从这里进。
- **raw**：收入 `raw/bookmarks/github.md` 列表；原文 URL 仍为 https://github.com/HKUDS/CLI-Anything
